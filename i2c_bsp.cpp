...
//#define EXAMPLE_USE_TOUCH   // Implementation of the touch screen
...
void I2C_master_Init(void)
{
  i2c_config_t conf = 
  {
    ...
    .master = {
      .clk_speed = 300 * 1000,               // Select frequency for the project
    },  
    .clk_flags = 0,                          // Optional, can use I2C_SCLK_SRC_FLAG_* flags to select I2C clock source
  };
